...
client=MongoClient("mongodb+srv://youtubepy:youtubepy@youtube-managermongodb.5imbpch.mongodb.net/",tlsAllowInvalidCertificates=True)
#not good idea to include id and password in code files
